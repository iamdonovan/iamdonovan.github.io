...
The aim of this module is to provide you with skills and experience to use programming tools for specialised and
reproducible GIS and remote sensing analysis. The topics covered include (but are not limited to):
...
Using open-source python packages, the module demonstrates how many standard GIS tools can be used programmatically
to automate repetitive tasks and produce repeatable analyses.

Before moving on to the :doc:`lectures` and :doc:`practicals<practicals/index>` below, be sure to visit the
